...
import com.merculia.carecomm.Frgments.ChatFrgment;
import com.merculia.carecomm.Frgments.CommFrgment;
import com.merculia.carecomm.Frgments.ContactFrgment;
import com.merculia.carecomm.MobileFragments.ConservationFragment;
        ...
        private void openMobileMenu(int position){
            if (position != RecyclerView.NO_POSITION){
                if (position != seletedPostion){
                    seletedPostion = position;
                    if (position == 0){
                        mainActivity.ReplaceFragmentWithBackstack(new ConservationFragment());
