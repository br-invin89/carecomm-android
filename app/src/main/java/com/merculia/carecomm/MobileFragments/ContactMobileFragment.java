...
//            inputType = getArguments().getInt(Constants.inputType);
    ...
    private void initViewWithData(){
        ...
        list.add(new MakeConservationModel("Daughter",R.drawable.main_photo_9,true));
        list.add(new MakeConservationModel("Mom",R.drawable.main_photo_8,true));
        list.add(new MakeConservationModel("Aunty",R.drawable.main_photo_6,true));
        list.add(new MakeConservationModel("Mother Law",R.drawable.main_photo_7,true));
        list.add(new MakeConservationModel("Daughter",R.drawable.main_photo_5,true));
        list.add(new MakeConservationModel("Wife",R.drawable.main_photo_1,true));
        list.add(new MakeConservationModel("Wife223",R.drawable.main_photo_1,true));
         */
